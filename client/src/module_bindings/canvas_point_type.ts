...
export namespace CanvasPoint {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: CanvasPoint): void {
    CanvasPoint.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): CanvasPoint {
    return CanvasPoint.getTypeScriptAlgebraicType().deserialize(reader);
  }
